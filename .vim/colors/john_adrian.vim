...
hi Comment      guifg=red gui=italic
"hi Comment      ctermfg=cyan cterm=none
hi Comment      ctermfg=red  cterm=none

highlight Constant   term=underline ctermfg=Yellow                      guifg=#ffa0a0
...
highlight Error                     ctermfg=Yellow     ctermbg=Red     guifg=Yellow   guibg=Red
...
highlight Exception                 ctermfg=Red        ctermbg=Yellow  guifg=Red      guibg=Yellow
highlight Typedef                   ctermfg=Yellow     ctermbg=Blue    gui=bold       guifg=Yellow guibg=Blue
highlight SpecialChar               ctermfg=Black      ctermbg=Yellow  guifg=Black    guibg=Yellow
highlight Delimiter                 ctermfg=Yellow     ctermbg=Black   guifg=Yellow   guibg=Black
